    ...
    <>
      <header
        ...
        className={`sticky font-semibold top-0 z-40 w-full transition-colors duration-300 ${
          scrolled
            ? "bg-sky-600/60 text-white backdrop-blur shadow-md"
            : "bg-transparent text-sky-600 hover:opacity-100 hover:bg-sky-600/60 hover:backdrop-blur hover:shadow-md hover:text-white"
        }`}
      >
